...
public class Trendyol_StepDefinitions {
    ...
    public void userSearchOnTheSearchBox(String item) {
        trendyolSearchPage.searchInputBox.sendKeys(item+Keys.ENTER);
    }

    @Then("user sees {string} on the result")
    public void userSeesOnTheResult(String item) {
